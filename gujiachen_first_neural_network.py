...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        self.delta_activationfun_hidden=lambda x: (1-x)*x               
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            hidden_error_term = hidden_error*self.delta_activationfun_hidden(hidden_outputs)[:,None]
...
# 
# #### 请将你的答案填写
# 预测效果前半段不错，后半段不好，应该是训练数据中的模式主要与前半段接近，另外模型中缺少偏置项，也是一个原因
